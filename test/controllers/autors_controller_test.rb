...
class AutorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create autor" do
    assert_difference("Autor.count") do
      post autors_url, params: { autor: { nacionalidade: @autor.nacionalidade, nome: @autor.nome } }
    end
  ...
  test "should update autor" do
    patch autor_url(@autor), params: { autor: { nacionalidade: @autor.nacionalidade, nome: @autor.nome } }
